function [waveform,fs] = useMATLABgenerator(channelBandwidth, NCellId, nSubFrames, startSubframe, fs, SCS, NSizeGrid, cp, caseP, NCRBSSB, kSSB, data)
% Generated by MATLAB(R) 23.2 (R2023b) and 5G Toolbox 23.2 (R2023b).
% Generated on: 05-May-2025 21:17:47
...
cfgDL.ChannelBandwidth = channelBandwidth;
cfgDL.NCellID = NCellId;
cfgDL.NumSubframes = nSubFrames;
cfgDL.InitialNSubframe = startSubframe;
...
ssburst.Enable = true;
ssburst.Power = 1;
ssburst.BlockPattern = caseP; % 'Case C'
ssburst.TransmittedBlocks = ones([1 8]);
ssburst.Period = 5;
ssburst.NCRBSSB = NCRBSSB;
ssburst.KSSB = kSSB;
ssburst.DataSource = data;
